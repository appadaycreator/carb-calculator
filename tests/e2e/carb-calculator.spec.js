...
const SVC_URL = "https://appadaycreator.com/carb-calculator/";
const SVC_NAME = "糖質・カーボ量計算ツール";

test.describe("糖質・カーボ量計算ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("carb-calculator");
